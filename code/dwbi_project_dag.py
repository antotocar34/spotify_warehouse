...
FACT_DIMENSION_DB_PATH = f"{DATA_HOME}/databases/data_warehouse.db"
...
def etl():
    ...
    def extract_db() -> List[str]:
        ...
        cnx = sqlite3.connect(f"{DATA_HOME}/databases/playlist.db")
    ...
    def load(csv_names: List[str]):
        ...
        data_base_path = f"{AIRFLOW_HOME}/data/databases/data_warehouse.db"
    ...
    def shift_to_Qlik(table_names: List[str]):
        """
        Output star schema table to click.
        """
